...
#         actor=actor, critic=critic, n_iters=n_iters
        ...
        for k in range(500):
            ...
            if k%2==0:
                ...
                # l_update_lr=(0.0002/pow((k+1),(2/3)))
                l1=l
...
#                 print("k_val,l_val,J_dl_val",k_val,l_val,J_dl_val)
            ...
            plt.savefig("./ltraining_score_Cartpole_A2C_l_6.svg")
            ...
            plt.savefig("./ltraining_std_Cartpole_A2C_v2C_l_6.svg")
            ...
            plt.savefig("./projected_l_value_Cartpole_A2C_l_6.svg")
